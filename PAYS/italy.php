...
$rec = $bdd->query('SELECT * FROM recettes WHERE IDpays = 10');
...
while($bonjour= $rec->fetch()){
    ...
    $img = $bonjour['image'];
?>
    <div class="new"><div class="articles"><a href="../recette.php?IDrecettes=<?=$bonjour['IDrecettes'];?>"><?= $recette; ?></a><img src="../IMG/<?=$img?>"></div></div>
<?php
}
?>
